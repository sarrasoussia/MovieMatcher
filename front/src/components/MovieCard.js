        ...
        return(
            <div className="card element-body">
                ...
                <div className="card-body">
                    ...
                    <p style={{color:"#abece9",fontWeight:"500"}}>Remove of favorites: <button onClick={this.RemoveFromFavorites} type="button" className="btn btn-outline-secondary" style={{ borderColor:"transparent",transform:"translate(0px,-3px)" }}><MdOutlineFavorite style={{fontSize: "25px"}}/></button></p></p>
