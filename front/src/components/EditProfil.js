...
function EditProfil(props) {
  ...
  return (
    <div>
      <button onClick={handleButtonClick} type="button" className="btn btn-outline-secondary" style={{ width: '40%', marginLeft: '28%', marginTop: '8px',borderColor:"red" }}>Edit Profile</button>
