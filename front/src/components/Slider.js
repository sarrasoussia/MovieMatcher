        ...
        <div style={{ backgroundColor: "black", borderRadius: "20px" }}>
          <div id="carouselExampleFade" className="carousel slide carousel-fade">
            <div className="carousel-inner">
                ...
                <div className="carousel-item" style={{ backgroundImage: "url('images/poster1.jpg')", backgroundSize: "cover", height: "30rem" }}>

                </div>

                <div className="carousel-item active" style={{ backgroundImage: "url('images/poster2.jpg')", backgroundSize: "cover", height: "30em" }}>
                ...
                <div className="carousel-item" style={{ backgroundImage: "url('images/poster.jpg')", backgroundSize: "cover", height: "30rem" }}>
                <div style={{backgroundColor:"rgba(0, 0, 0, 0.6)",width:"18%",marginLeft:"40%",marginTop:"5px",borderRadius:"20px",height:"15%"}}>
                  <h1 className=" text-white text-center display-1 py-3" style={{fontFamily: "cinematic",fontSize:"47px",marginTop:"-18px"}}> Our <span style={{color:"red"}}> Features !</span> </h1>
                  </div>
                </div>
